...
#ifndef FL_fuzzylegacy_H
#define	FL_fuzzylegacy_H
...
#define FL_LOG(message) if (fl::fuzzylegacy::logging()){std::cout << FL_LOG_PREFIX << message << std::endl;}
#define FL_LOGP(message) if (fl::fuzzylegacy::logging()){std::cout << message << std::endl;}

#ifndef FL_DEBUG
#define FL_DEBUG false
#endif

#define FL_BEGIN_DEBUG_BLOCK if (fl::fuzzylegacy::debug()){
